                                ...
                                <div class="col-md-6">
                                    ...
                                    if (isset($_POST['change_profile'])) {
                                        ...
                                        if (move_uploaded_file($tmp_name, $target)) {
                                            $update_query = "UPDATE patient SET profile='$img' WHERE name='$pat'";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <?php
                                        echo "<img src='img/" . $row['profile'] . "' class='img-fluid' alt='Patient Image' style='width: 200px;  border-radius: 10%;'>";
                                        ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="post">
                                        ...
                                        if (isset($_POST['change_name'])) {
                                            $new_name = $_POST['name'];
                                            $update_query = "UPDATE patient SET name='$new_name' WHERE name='$pat'";
                                            mysqli_query($connect, $update_query);
                                            echo "<script>alert('Name updated successfully!');</script>";
                                            echo "<script>window.location.href='profile.php';</script>";
                                            if ($result) {
                                                $_SESSION['patient'] = $new_name; // Update session variable
                                            } else {
                                    ...
                                    if (isset($_POST['change_password'])) {
                                        ...
                                        $check_query = "SELECT * FROM patient WHERE name='$pat' AND password='$current_password'";
                                        $check_result = mysqli_query($connect, $check_query);

                                        if (mysqli_num_rows($check_result) > 0) {
                                            if ($new_password === $confirm_password) {
                                                // Update password
                                                $update_query = "UPDATE patient SET password='$new_password' WHERE name='$pat'";
                                                mysqli_query($connect, $update_query);
